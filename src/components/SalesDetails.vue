...
<template>
    <div class="border-t border-gray-200 space-y-6 py-6">
        ...
        <ul role="list" class="mt-10 divide-y divide-gray-200 border-t border-gray-200 text-sm font-medium text-gray-500">
            <li v-for="item in sale.items" class="flex space-x-6 py-6">
                <img :src="item.image" :alt="'Imagen de ' + item.name" class="h-24 2-24 flex-none rounded-lg">
